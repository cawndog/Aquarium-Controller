...
void TimedPowerEventControl::initNewSettings() {
    this->devices[0].initDeviceState(this->rtc, this->powerControl);
    this->devices[1].initDeviceState(this->rtc, this->powerControl);
    this->devices[2].initDeviceState(this->rtc, this->powerControl);
    this->determineDeviceWithNextEvent();
}
